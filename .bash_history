...
cd test_models/
ls
rm test_base.py test_rectangle.py test_square.py 
ls
cd ..
ls
rmdir test_models/
...
cd models/
ls
rm base.py rectangle.py square.py 
ls
cd ..
ls
rmdir models/
...
git status
git add .
git commit -m "Exacutable"
git push origin master
ping www.google.com
exit
git status
ls
ch holbertonschool-higher_level_programming/
cd holbertonschool-higher_level_programming/
l
ls
ls
...
ls
git status
cd holbertonschool-higher_level_programming/i
cd holbertonschool-higher_level_programming/
ls
cd 0x0C-python-almost_a_circle/
ls
...
exit
ls
echo "# sorting_algorithms" >> README.md
git init
git add README.md
git commit -m "first commit"
git remote add origin git@github.com:Lucho-ai/sorting_algorithms.git
git push -u origin master
ls
git https://github.com/Lucho-ai/sorting_algorithms.git
git clone https://github.com/Lucho-ai/sorting_algorithms.git
ls
...
git push origin master
nano README.md
nano 0-bubble_sort.c
git status
git add README.md 
git commit -m "README project"
git push origin master
git add 0-bubble_sort.c 
git commit -m "Bubble file"
git push origin master
nano 1-O
nano 1-insertion_sort_list.c
git status
git add 1-O
git commit -m "Bub file"
git push origin master
git add 1-insertion_sort_list.c
git commit -m "Insertion file"
git push origin master
nano 2-O
ls
nano 2-selection_sort.c
git status
git add 2-O 
git commit -m "bubble"
git push origin master
...
ls
chmod u+x 1-list_your_processes 2-show_your_bash_pid 3-show_your_bash_pid_made_easy 4-to_infinity_and_beyond 5-kill_me_now 6-kill_me_now_made_easy 7-highlander 8-beheaded_process 
ls
git status
git add 1-list_your_processes 2-show_your_bash_pid 3-show_your_bash_pid_made_easy 4-to_infinity_and_beyond 5-kill_me_now 6-kill_me_now_made_easy 7-highlander 8-beheaded_process 
git commit -m "Executable files"
git push origin master
ls
git status
exit
